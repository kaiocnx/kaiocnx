...
public:
	...
	void ClearCustom();
	void AddCustom(BYTE Index[2], BYTE Sign, BYTE Patent);
	ViewportCustomInfo* GetCustom(short Index);

private:
	std::unordered_map<short, ViewportCustomInfo> Custom;
};
